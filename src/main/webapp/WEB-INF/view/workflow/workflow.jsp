...
<body>
					...
					<%-- <s:if test="#depList!=null && #depList.size()>0">
						<s:iterator value="#depList">
							<tr>
								...
								<td height="20" bgcolor="#FFFFFF" class="STYLE19"><div
										align="center">
										<s:date name="deploymentTime" format="yyyy-MM-dd HH:mm:ss" />
									</div></td>
								<td height="20" bgcolor="#FFFFFF"><div align="center"
										class="STYLE21">
										<a
											href="workflowAction_delDeployment.action?deploymentId=<s:property value="id"/>">删除</a>
									</div></td>
							</tr>
						</s:iterator>
					</s:if> --%>
					...
					<%-- <s:if test="#pdList!=null && #pdList.size()>0">
						<s:iterator value="#pdList">
							<tr>
								...
								<td height="20" bgcolor="#FFFFFF" class="STYLE6"><div
										align="center">
										<s:property value="diagramResourceName" />
									</div></td>
								<td height="20" bgcolor="#FFFFFF" class="STYLE6"><div
										align="center">
								...
								<td height="20" bgcolor="#FFFFFF"><div align="center"
										class="STYLE21">
										<a target="_blank"
											href="workflowAction_viewImage.action?deploymentId=<s:property value="deploymentId"/>&imageName=<s:property value="diagramResourceName"/>">查看流程图</a>
									</div></td>
							</tr>
						</s:iterator>
					</s:if> --%>
	...
	<br />
	<!-- 发布流程 -->
	<form action="${pageContext.request.contextPath }/workflow/deployment"
